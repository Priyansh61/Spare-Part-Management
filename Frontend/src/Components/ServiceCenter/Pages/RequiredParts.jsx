        ...
        <div className="relative bg-white py-6 px-20 rounded-3xl w-11/12 my-4 shadow-xl max-md:w-full max-sm:p-6">
          <form className="grid grid-cols-1 gap-3 mt-5" onSubmit={handleSubmit}>
            ...
            <div className="my-2 w-full flex justify-center ">
              <button className="w-1/2 mt-4 xl:w-2/5 md:w-1/2 text-center max-sm:w-full uppercase text-sm font-bold tracking-wide bg-orange-500 text-gray-100 p-3 rounded-lg focus:outline-none focus:shadow-outline">
                Check Availability
              </button>
            </div>
          </form>
